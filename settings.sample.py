...
posts = {
    ...
    'embedded_fields': ['writers','photographers','designers','engineers','heroImage', 'topics', 'sections', 'categories', 'tags', 'og_image'],
...
meta = {
    ...
    'resource_methods': ['GET'],
    'embedded_fields': ['heroImage','writers', 'topics','sections', 'categories','og_image'],
    'cache_control': 'max-age=300,must-revalidate',
    'cache_expires': 300,
    'allow_unknown': False,
    'schema': meta_schema
